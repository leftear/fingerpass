...
namespace gazugafan.fingerpass
{
  public partial class DatabaseForm : Form
  {
    ...
    private void DatabaseForm_Load(object sender, EventArgs e)
    {
      ...
      passwordsDataGrid.Columns.Add(eColumn.programNameColumn.ToString(), "Program Name");
      passwordsDataGrid.Columns.Add(eColumn.windowTitleColumn.ToString(), "Window Title");
      passwordsDataGrid.Columns.Add(eColumn.passwordColumn.ToString(), "Password");
    ...
    private void btnInsert_Click(object sender, EventArgs e)
    {
      ...
      {
        DataGridViewRow row = passwordsDataGrid.SelectedRows[0];
        row.Cells[eColumn.programNameColumn.ToString()].Value = _currentProgramName;
        row.Cells[eColumn.windowTitleColumn.ToString()].Value = _currentWindowTitle;
      }
    }
  }
}
